...
import com.geozen.smarttrail.ui.phone.TrailsActivity;
 ...
 */
public class TrailsMultiPaneActivity extends BaseMultiPaneActivity implements
	...
	public FragmentReplaceInfo onSubstituteFragmentForActivityLaunch(
		...
		if (TrailsActivity.class.getName().equals(activityClassName)) {
			return new FragmentReplaceInfo(TrailsFragment.class, "trails",
					R.id.fragment_container_trails);
		} else if (TrailDetailActivity.class.getName()
				.equals(activityClassName)) {
			findViewById(R.id.fragment_container_trail_detail)
					.setBackgroundColor(0xffffffff);
			return new FragmentReplaceInfo(TrailDetailFragment.class,
					"trail_detail", R.id.fragment_container_trail_detail);
		}
		return null;
	}
