...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    public ProgressBar getProgressBar() {
    	return (ProgressBar) mActivity.findViewById(R.id.actionbar_compat_item_progress);
    }
    public ImageButton getProviderView() {
    	return (ImageButton) mActivity.findViewById(R.id.actionbar_compat_item_provider);
    }
    ...
    private void addActionItemCompatFromMenuItem(final MenuItem item) {
        ...
        if (item.getItemId() == R.id.menu_refresh) {
            ...
            // so add those.
        	ProgressBar indicator = new ProgressBar(mActivity, null,
                    R.attr.actionbarCompatProgressBarIndicatorStyle);
            ...
            indicator.setId(R.id.actionbar_compat_item_progress);
